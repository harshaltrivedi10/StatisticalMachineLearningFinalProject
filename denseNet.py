...
# Import Densnet model, with weights pre-trained on ImageNet.
# Densnet model without the last classifier layers (include_top = False)
densenet_model = tf.keras.applications.densenet.DenseNet121(include_top=False,input_shape=(221, 221, 3),weights='imagenet')
...
# updated code
filepath = "/home/dmalaviy/data/model/modelDenseNet1.h5"
...
model.load_weights('/home/dmalaviy/data/model/modelDenseNet1.h5')
